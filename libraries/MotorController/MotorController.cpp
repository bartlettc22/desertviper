...
// Public Methods //////////////////////////////////////////////////////////////
void MController::init(unsigned char INA1, unsigned char INB1, unsigned char EN1DIAG1, unsigned char PWM1, unsigned char CS1, 
                                               unsigned char INA2, unsigned char INB2, unsigned char EN2DIAG2, unsigned char PWM2, unsigned char CS2)
{
...
void MController::setM1Speed(int speed)
{
...
void MController::setM2Speed(int speed)
{
  unsigned char reverse = 0;
...
void MController::setSpeeds(int m1Speed, int m2Speed)
{
  setM1Speed(m1Speed);
  setM2Speed(m2Speed);
}
...
void MController::setM1Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void MController::setM2Brake(int brake)
{
  // normalize brake
  if (brake < 0)
  {
...
void MController::setBrakes(int m1Brake, int m2Brake)
{
  setM1Brake(m1Brake);
  setM2Brake(m2Brake);
}
...
unsigned int MController::getM1CurrentMilliamps()
{
...
unsigned int MController::getM2CurrentMilliamps()
{
  // 5V / 1024 ADC counts / 144 mV per A = 34 mA per count
...
unsigned char MController::getM1Fault()
{
  return !digitalRead(_EN1DIAG1);
}

// Return error status for motor 2 
unsigned char MController::getM2Fault()
{
